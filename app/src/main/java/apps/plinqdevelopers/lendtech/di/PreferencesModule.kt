...
object PreferencesModule {
    ...
    fun providePreferencesManager(@ApplicationContext context : Context) : DataStore<Preferences> {
        return PreferenceDataStoreFactory.create(
            ...
            produceFile = { context.preferencesDataStoreFile(name = APP_PREFERENCES_NAME) },
            migrations = listOf(SharedPreferencesMigration(context = context, sharedPreferencesName = APP_PREFERENCES_NAME))
        )
    }
}